...
class PerlFileMimeinfo(PerlPackage):
    ...
    you should use File::MimeInfo::Magic in combination with
    IO::Scalar.

    This module loads the various data files when needed. If you want
    to hash data earlier see the rehash methods below.
    """
    ...
    depends_on("perl-file-basedir")

    # FIXME: check these dependencies!
    # depends_on("perl-file-desktopentry")
    # depends_on("perl-pod-usage")
